...
__all__ = ["SimulatedAtomsDataModule", "AtomsDataModuleError"]
...
class SimulatedAtomsDataModule(pl.LightningDataModule):
    """
    ...
    def __init__(
        ...
        self._ood_test_transforms = test_transforms or copy(transforms) or []
        self._iid_test_transforms = test_transforms or copy(transforms) or []
        self._virtual_test_transforms = test_transforms or copy(transforms) or []
        ...
        self.train_idx = None
        self.val_idx = None
        self.iid_test_idx = None
        self.ood_test_idx = None
        self.virtual_test_idx = None
        
        self.dataset = None
        self._train_dataset = None
        self._val_dataset = None
        self._ood_test_dataset = None
        self._iid_test_dataset = None
        self._virtual_test_dataset = None

        self._train_dataloader = None
        self._val_dataloader = None
        self._ood_test_dataloader = None
        self._iid_test_dataloader = None
        self._virtual_test_dataloader = None
    ...
    @property
    def ood_test_transforms(self):
        """
        Optional transforms (or collection of transforms) you can apply to test dataset.
        """
        return self._ood_test_transforms
    
    @property
    def iid_test_transforms(self):
        """
        Optional transforms (or collection of transforms) you can apply to test dataset.
        """
        return self._iid_test_transforms
    
    @property
    def virtual_test_transforms(self):
        """
        Optional transforms (or collection of transforms) you can apply to test dataset.
        """
        return self._virtual_test_transforms
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if self.dataset is None:
            ...
            self._ood_test_dataset = self.dataset.subset(self.ood_test_idx)
            self._iid_test_dataset = self.dataset.subset(self.iid_test_idx)
            self._virtual_test_dataset = self.dataset.subset(self.virtual_test_idx)
    ...
    def teardown(self, stage: Optional[str] = None):
        ...
        for t in self.val_transforms:
            t.teardown()
        for t in self.ood_test_transforms:
            t.teardown()
        for t in self.iid_test_transforms:
            t.teardown()
        for t in self.virtual_test_transforms:
            t.teardown()
    ...
    def _setup_transforms(self):
        ...
        self._ood_test_dataset.transforms = self.ood_test_transforms
        self._iid_test_dataset.transforms = self.iid_test_transforms
        self._virtual_test_dataset.transforms = self.virtual_test_transforms
    ...
    @property
    def ood_test_dataset(self) -> BaseAtomsData:
        return self._ood_test_dataset
    
    @property
    def iid_test_dataset(self) -> BaseAtomsData:
        return self._iid_test_dataset
    
    @property
    def virtual_test_dataset(self) -> BaseAtomsData:
        return self._virtual_test_dataset
    ...
    def ood_test_dataloader(self) -> AtomsLoader:
        if self._ood_test_dataloader is None:
            self._ood_test_dataloader = AtomsLoader(
    ...
    def iid_test_dataloader(self) -> AtomsLoader:
        ...
        return self._iid_test_dataloader
    ...
    def virtual_test_dataloader(self) -> AtomsLoader:
        ...
        return self._virtual_test_dataloader
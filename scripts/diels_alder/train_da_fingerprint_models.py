...
if __name__ == "__main__":
    split_idx = 0
    name = f'fingeprint_split_{split_idx}_pre_100'
    ...
    dataset = Dataset(
        folder_path=f"da/fingerprint_splits_2/split_{split_idx}/"
    )
    ...
    if evaluate_on_dataset:
        ...
        if save_simulated_dataset:
            df.to_csv(f'./data/da/local_simulated_DA_literature_{split_idx}.csv')

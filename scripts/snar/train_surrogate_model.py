...
if __name__ == "__main__":
    n_replications = 1
    name = 'snar_rps_regression_pretrained'
    ...
    if evaluate_on_dataset:
        dataset = Dataset(
            folder_path="snar/snar_literature/"
        )
        source_data = dataset.load()
        ...
        #     df.to_csv('./data/snar/global_simulated_snar_literature.csv')
        ...
        for idx in [1]:
            ...
            print('EVALUATION ON DATASET SCORE (SnAr literature)')
            print(len(sim_df))

...
###
### 4. Train model on exp + local simulations (subset) Transductive
###
...
###
### 4.5 Train model on exp + local (XTB) simulations (subset) Transductive
###
...
###
### 6. Train model on exp + XTB simulations Non-Transductive
###
...
###
### 7. Train model on exp + local simulations (subset) Non-Transductive
###
...
###
### 7.5 Train model on exp + local (XTB) simulations (subset) Non-Transductive
###
...
###
### 8. Train model on exp + local simulations (whole) Non-Transductive
###

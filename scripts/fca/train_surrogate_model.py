...
if __name__ == "__main__":
    ...
    if evaluate_on_dataset:
        dataset = Dataset(
            folder_path="fca/fca_literature/"
        )
        source_data = dataset.load()
        ...
        #     df.to_csv('./data/fca/global_simulated_DA_literature.csv')
        ...
        for idx in [1]:
            ...
            print('EVALUATION ON DATASET SCORE (FCA literature)')
            print(len(sim_df))
